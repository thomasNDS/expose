...
window.LGMaps.maps.europeanUnion = {
	...
	"paths": [
		...
		},
		{
			...
			"name": "Finland",
			"abbreviation": "FI",
			"color": ((selected === "Finland") ? selectedColor :colorC),
			"selectedColor": ((selected === "Finland") ? selectedColor :colorC),
			"hoverColor": hoverC,
			 "text": "",
		...
		},
		{
			...
			"name": "Greece",
			"abbreviation": "GR",
			"color": ((selected === "Greece") ? selectedColor :colorC),
			"selectedColor": ((selected === "Greece") ? selectedColor :colorC),
			"hoverColor": hoverC,
			 "text": "",
		...
		},
		{
			...
			"selectedColor": ((selected === "Romania") ? selectedColor :colorB),
			"hoverColor": hoverB,
			 "text": "",
		...
		},
		{
			...
			"selectedColor": ((selected === "United Kingdom") ? selectedColor :"#AAA"),
			"hoverColor": "#BBB",
			 "text": "",
